...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #eb355d 10%, #ffb4cd 90%);
        }
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            <div class="pl-4 flex items-center">
                <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    ...
                    <svg class="h-10 fill-current inline mb-1" version="1.1" id="Capa_1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 477.899 477.899" style="enable-background:new 0 0 477.899 477.899;"
                        xml:space="preserve">
                        <g>
                            <g>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    <li class="mr-3">
                        <a class="inline-block text-gray-700 no-underline hover:text-black hover:underline transition duration-300 py-2 px-4"
                            href="#">Mahasiswa</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block text-gray-700 no-underline hover:text-black hover:underline transition duration-300 py-2 px-4"
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-1/2 justify-center items-start text-center md:text-left">
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Ayo simpan kemenanganmu disini!
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    Buat teman-temanmu termotivasi dengan pencapaian terbesarmu!
                </p>
                {{-- <span class="my-6 py-4"></span> --}}
            </div>
            <!--Right Col-->
            <div class="w-full md:w-1/2 py-10 text-center">
                <img class="w-full md:w-4/5 z-50" src="{{ asset('img/hero.svg') }}" />
            </div>
        </div>
    </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
            Kami mengapresiasi pencapaian anda
        </h1>
        <div class="w-full mb-4">
        ...
        <p>© {{ Carbon\Carbon::now()->format('Y') }} Premio By Damar</p>
    </section>
